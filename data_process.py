...
def line_parse_sample(line_str: str, line_id: int) -> TmcSample:
...
def parse_samples_file(file_path: str) -> List[TmcSample]:
    i = 1
    tmc_samples_list = []
...
def split_train_val(
    tmc_samples: List[TmcSample],
    random_seed: int,
) -> Tuple[List[TmcSample], List[TmcSample]]:
